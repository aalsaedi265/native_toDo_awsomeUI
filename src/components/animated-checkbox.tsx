...
import { Pressable,Easing  } from 'react-native'
...
interface Props{
   ...
   const AnimatedCheckBox = (props:Props)  =>{
    ...
    const animatedBox_theProp= useAnimatedProps(()=>({
                stroke: interpolateColor(
                Easing.bezier(0.16,1,0.3,1)(progress.value),
                [0,1],
                [boxOutlineColor, highlightColor], 'RGB'
                ),
                fill:interpolateColor(
                    Easing.bezier(0.16,1,0.3,1)(progress.value),
                    [0,1],
                    ['#00000000', highlightColor], 'RGB'
                )
    ...
    return(
        <Svg viewBox={[-Margin, -Margin, vWidth+ Margin, vHeight + Margin].join(' ')} >  
            ...
            <Path fill="none"
             ...
             <AnimatedPath d={box_drawing}
             strokeWidth={7}
             strokeLinejoin='round'
             strokeLinecap='round'
             animatedProps={animatedBox_theProp} />
